...
namespace Arieo
{
    void MainModule::loadManifest(const std::string& manifest_context)
    {
        ...
        // Load root archive
        {
            ...
            m_root_archive = archive_factory->createArchive(Base::Interop::StringView(std::string_view(content_root_path.string())));
    ...
    Base::Interop::SharedRef<Interface::Archive::IArchive> MainModule::getRootArchive()
    {
